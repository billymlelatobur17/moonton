          ...
          <div>
              ...
              <form className="w-[370px]">
                  <div className="flex flex-col gap-6">
                      <div>
                          <InputLabel value="Full Name" forInput={'fullName'} />
                          <TextInput type="text" name="fullname" placeholder="Your fullname..." defaultValue="Angga React" />
                      </div>
                      <div>
                          <InputLabel value="Email Address" forInput={'email address'} />
                          <TextInput type="email" name="email" defaultValue="anggaforreact@fb.com" />
                      </div>
                      <div>
